...
```{r}
T1 <- st_intersection( buffs, oh_parks_p_studyarea)


tm_shape(study.area_p)+ tm_polygons(fill = "NAME")+ 
  tm_shape(T1) + tm_polygons(fill = "FEATTYPE", palette = "brewer.dark2") +
  tm_shape(streams.303d) + tm_lines(col = "purple")
...
```{r}
T2 <- st_intersection(streams.303d, oh_parks_p_studyarea )
